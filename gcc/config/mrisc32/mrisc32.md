...
(define_insn "*mov<mode>"
  [(set (match_operand:ANYI 0 "nonimmediate_operand"      "=r,r,r,r,  A,A,BCW,BCW")
	(match_operand:ANYI 1 "mrisc32_int_movsrc_operand" "r,i,A,BCW,r,Z,r,  Z"))]
...
;; TODO(m): Merge this with the integer version above.
(define_insn "*mov<mode>"
  [(set (match_operand:ANYF 0 "nonimmediate_operand"        "=r,r,r,r,  A,A,BCW,BCW")
	(match_operand:ANYF 1 "mrisc32_float_movsrc_operand" "r,F,A,BCW,r,Z,r,  Z"))]
  "register_operand (operands[0], <MODE>mode)
   || mrisc32_reg_or_zero_operand (operands[1], <MODE>mode)"
  "@
   mov\\t%0, %1
