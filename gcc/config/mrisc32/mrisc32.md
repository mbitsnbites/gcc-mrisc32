  ...
  ""
{
  ...
  emit_insn (gen_smulsi3_highpart (
      simplify_gen_subreg (SImode, operands[0], DImode, UNITS_PER_WORD),
      operands[1], operands[2]));
  emit_insn (gen_movsi (
      simplify_gen_subreg (SImode, operands[0], DImode, 0),
      temp));
  DONE;
})
...
;; -------------------------------------------------------------------------
;; Extract a byte or half-word from a word using the SHUF instruction.
;; -------------------------------------------------------------------------
