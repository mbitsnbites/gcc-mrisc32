...
;; probably do better, but we seem to catch the most important cases and
;; produce decent code.

(define_insn "*movsicc_simple"
  [(set (match_operand:SI 0 "register_operand" "=&r,&r,&r,&r")
	(if_then_else:SI
	  (match_operator 5 "mrisc32_set_comparison_operator"
	    [(match_operand:SI 1 "register_operand"             "r,r,r,r")
	     (match_operand:SI 2 "mrisc32_reg_or_imm15_operand" "r,I,r,I")])
	  (match_operand:SI 3 "register_operand"                "r,r,r,r")
	  (match_operand:SI 4 "mrisc32_reg_or_imm15_operand"    "r,r,I,I")))]
  ""
  "@
   ...
   s%S5\\t%0, %1, %2\;sel\\t%0, %3, #%4
   s%S5\\t%0, %1, #%2\;sel\\t%0, %3, #%4"
  [(set_attr "type" "multi_2alu,multi_2alu,multi_2alu,multi_2alu")
   (set_attr "length" "8,8,8,8")])

(define_insn "*movsicc_swap_src"
  [(set (match_operand:SI 0 "register_operand" "=&r,&r,&r,&r")
	(if_then_else:SI
	  (match_operator 5 "mrisc32_set_rev_comparison_operator"
	    [(match_operand:SI 1 "register_operand"             "r,r,r,r")
	     (match_operand:SI 2 "mrisc32_reg_or_imm15_operand" "r,I,r,I")])
	  (match_operand:SI 3 "register_operand"                "r,r,r,r")
	  (match_operand:SI 4 "mrisc32_reg_or_int_zero_operand" "r,r,O,O")))]
  ""
  "@
   s%R5\\t%0, %1, %2\;sel\\t%0, %4, %3
   s%R5\\t%0, %1, #%2\;sel\\t%0, %4, %3
   s%R5\\t%0, %1, %2\;sel\\t%0, z, %3
   s%R5\\t%0, %1, #%2\;sel\\t%0, z, %3"
  [(set_attr "type" "multi_2alu,multi_2alu,multi_2alu,multi_2alu")
   (set_attr "length" "8,8,8,8")])

(define_insn "*movsicc_swap_cmp"
  [(set (match_operand:SI 0 "register_operand" "=&r,&r,&r,&r")
	(if_then_else:SI
	  (match_operator 5 "mrisc32_set_rev_comparison_operator"
	    [(match_operand:SI 1 "register_operand"                "r,r,r,r")
	     (match_operand:SI 2 "mrisc32_reg_or_int_zero_operand" "r,O,r,O")])
	  (match_operand:SI 3 "register_operand"                   "r,r,r,r")
	  (match_operand:SI 4 "mrisc32_reg_or_imm15_operand"       "r,r,I,I")))]
  ""
  "@
   s%R5\\t%0, %2, %1\;sel\\t%0, %3, %4
   s%R5\\t%0, z, %1\;sel\\t%0, %3, %4
   s%R5\\t%0, %2, %1\;sel\\t%0, %3, #%4
   s%R5\\t%0, z, %1\;sel\\t%0, %3, #%4"
  [(set_attr "type" "multi_2alu,multi_2alu,multi_2alu,multi_2alu")
   (set_attr "length" "8,8,8,8")])

;; TODO(m): This does not seem to be used. Why?

(define_insn "*movsfcc_simple"
...
;;   sel_1  mask, b, a  (overwrite mask)
;;   sel_2  a, mask, b  (overwrite a)
;;   sel_3  b, mask, a  (overwrite b)
;;
;; Operands:
;;   0: result
;;   1: a
...
(define_insn "mrisc32_sel"
	...
	(xor:SI
	  (and:SI
	    (xor:SI (match_operand:SI 1 "register_operand"             "r,r,0,r")
		    (match_operand:SI 2 "mrisc32_reg_or_imm15_operand" "r,I,r,0"))
  ...
  "@
   ...
   sel_2\\t%1, %3, %2
   sel_3\\t%2, %3, %1"
  [(set_attr "type" "logical,logical,logical,logical")])
...
(define_insn "*call"
  [(call (mem:SI (match_operand:SI 0 "mrisc32_call_insn_operand" "r,s"))
	 (match_operand 1))
   (clobber (reg:SI MRISC32_LR))]
  "!SIBLING_CALL_P (insn)"
  "@
...
(define_insn "*sibcall"
  [(call (mem:SI (match_operand:SI 0 "mrisc32_call_insn_operand" "c,s"))
	 (match_operand 1))]
  "SIBLING_CALL_P (insn)"
  "@
   j\\t%0
...
(define_insn "*call_value"
  [(set (match_operand 0)
	(call (mem:SI (match_operand:SI 1 "mrisc32_call_insn_operand" "r,s"))
	      (match_operand 2)))
   (clobber (reg:SI MRISC32_LR))]
  "!SIBLING_CALL_P (insn)"
  "@
...
(define_insn "*sibcall_value"
  [(set (match_operand 0)
	(call (mem:SI (match_operand:SI 1 "mrisc32_call_insn_operand" "c,s"))
	      (match_operand 2)))]
  "SIBLING_CALL_P (insn)"
  "@
   j\\t%1
