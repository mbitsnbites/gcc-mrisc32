	...
	(if_then_else:SI
	  (match_operator 5 "mrisc32_set_rev_comparison_operator"
	    [(match_operand:SI 1 "register_operand"             "r,r,r,r,r")
	     (match_operand:SI 2 "mrisc32_reg_or_imm15_operand" "r,I,r,I,O")])
	  (match_operand:SI 3 "register_operand"                "r,r,r,r,r")
	  (match_operand:SI 4 "mrisc32_reg_or_imm15_operand"    "r,r,I,O,I")))]
  ""
  "@
   s%R5\\t%0, %1, %2\;sel_1\\t%0, %3, %4
   s%R5\\t%0, %1, #%2\;sel_1\\t%0, %3, %4
   s%Q5\\t%0, %2, %1\;sel\\t%0, %3, #%4
   s%R5\\t%0, %1, #%2\;sel_1\\t%0, %3, z
...
(define_insn "*movsfcc_rev"
  ...
  "TARGET_HARD_FLOAT"
  "@
   fs%R5\\t%0, %1, %2\;sel_1\\t%0, %3, %4
   fs%R5\\t%0, %1, z\;sel_1\\t%0, %3, %4
   fs%R5\\t%0, %1, %2\;sel_1\\t%0, %3, z
   fs%R5\\t%0, %1, z\;sel_1\\t%0, %3, z"
  [(set_attr "type" "multi_2alu")
   (set_attr "length" "8")])
...
(define_expand "cbranchsi4"
  [(use (match_operator 0 "ordered_comparison_operator"
         [(match_operand:SI 1 "register_operand")
          (match_operand:SI 2 "mrisc32_reg_or_imm15_operand")]))
   (use (match_operand 3 ""))]
  ""
{
