...
#define FIXED_REGISTERS {                                         \
  ...
  /*  s8  s9 s10 s11 s12 s13 s14 s15 */   0, 0, 0, 0, 0, 0, 0, 0, \
  /* s16 s17 s18 s19 s20 s21 s22 s23 */   0, 0, 0, 0, 0, 0, 0, 0, \
  /* s24 s25  fp  tp  sp  vl  lr  pc */   0, 0, 1, 1, 1, 1, 1, 1, \
...
#define CALL_REALLY_USED_REGISTERS {                              \
  ...
  /*  s8  s9 s10 s11 s12 s13 s14 s15 */   1, 1, 1, 1, 1, 1, 1, 1, \
  /* s16 s17 s18 s19 s20 s21 s22 s23 */   0, 0, 0, 0, 0, 0, 0, 0, \
...
#define TARGET_CPU_CPP_BUILTINS()       \
  {                                     \
    builtin_define_std ("__MRISC32__"); \
  }
