/* Prototypes for mrisc32.cc functions used in the md file & elsewhere.
...
extern bool mrisc32_is_i15 (const int ival);
extern bool mrisc32_is_i15hl (const int ival);
...
extern bool mrisc32_regno_ok_for_index_p (int, bool);
extern bool mrisc32_regno_ok_for_base_p (int, bool);
extern bool mrisc32_reg_based_mem_ref_p (rtx, bool);
...
extern bool mrisc32_is_mask_offset_suitable_for_ibf (rtx, rtx, rtx);
extern rtx mrisc32_legitimize_call_address (rtx);
extern rtx mrisc32_mask_to_shuf_ctrl (rtx);
extern void mrisc32_mask_to_mkbf_width_offset (rtx, rtx, rtx *, rtx *);
